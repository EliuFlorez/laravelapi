<?php namespace Authority\Repository\Session;

use Cartalyst\Sentry\Sentry;
use Authority\Repository\RepoAbstract;

class SentrySession extends RepositoryAbstract implements SessionInterface {
