<?php namespace Authority\Repository\User;

use Mail;
use Cartalyst\Sentry\Sentry;
use Authority\Repository\RepositoryAbstract;

class SentryUser extends RepositoryAbstract implements UserInterface {
